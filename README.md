...
>   [EntityRowView.swift](/Users/jin/Documents/HA/NativeHA/Sources/NativeHA/Cards/EntityRowView.swift:31) uses simple `HStack` spacing/padding and native controls. HA’s generic entity row uses `state-badge`, 40px icon allocation, text overflow rules, focus-visible background, pointer behavior, and action handling in [hui-generic-entity-row.ts](/Users/jin/Documents/HA/hass-frontend/src/panels/lovelace/components/hui-generic-entity-row.ts:70) and CSS at [hui-generic-entity-row.ts](/Users/jin/Documents/HA/hass-frontend/src/panels/lovelace/components/hui-generic-entity
